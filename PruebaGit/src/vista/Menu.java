...
public class Menu extends javax.swing.JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent evento) {
        if(evento.getSource()==jMenuItem1){
            ...
            gUILibro.init(registroLibros, gUILibro);
            gUILibro.setVisible(true);
        }
        
             if(evento.getSource()==jMenuItem3){
            GuiReporteLibro guiReporteLibro = new GuiReporteLibro();
            guiReporteLibro.init(registroLibros);
            guiReporteLibro.setVisible(true);
        }
